...
<p style="font-size: 15px; text-align: center;"><b>In parallel to the extensive diversity that we see in NLR alleles is an enormous strain diversity in the pathogens of <em>A. thaliana</em>. We are working to understand how this diversity is shaped and maintained.</b></p>

  
<div style="display: flex; align-items: flex-start; gap: 10px;">
  <img src="../assets/images/CI-Image.jpg" alt="Related NLR Image" style="max-width: 450px; height: auto;">
  <div>
